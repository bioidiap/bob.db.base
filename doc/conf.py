...
distribution = pkg_resources.require('xbob.db')[0]
...
latex_documents = [
  ('index', 'xbob_db.tex', u'Bob Database Support Documentation', 
...
man_pages = [
    ('index', 'xbob_db', u'Bob Database Support Documentation', [u'Idiap Research Institute'], 1)
]
