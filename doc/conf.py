...
project = u'xbob.db.base'
import time
copyright = u'%s, Idiap Research Institute' % time.strftime('%Y')

# Grab the setup entry
distribution = pkg_resources.require('xbob.db.base')[0]
...
htmlhelp_basename = 'xbob_db_base_doc'
...
latex_documents = [
  ('index', 'xbob_db_base.tex', u'Bob Database Support Documentation',
...
man_pages = [
    ('index', 'xbob_db_base', u'Bob Database Support Documentation', [u'Idiap Research Institute'], 1)
]
